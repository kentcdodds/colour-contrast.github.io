...
//language=SCSS
const SnippetCollection = glamorous.div({
  width: '38%',
...
export default class extends React.Component {
  render() {
    return (
      <SnippetCollection>
        <Snippet fontSize="10pt" colour={this.props.colour}>
          {loremIpsum}
        </Snippet>
        <Snippet fontSize="14pt" colour={this.props.colour}>
          {loremIpsum}
        </Snippet>
        <Snippet fontSize="18pt" colour={this.props.colour}>
          {loremIpsum}
        </Snippet>
      </SnippetCollection>
    );
